    ...
    , ui_(new Ui::MainWindow)
{
    ...
    // rosNode
    QObject::connect(ui_->pushButton_ros_send, &QPushButton::clicked, this, &MainWindow::slot_btn_rosNode_send);
 ...
 * ROS发送数据按钮
 */
void MainWindow::slot_btn_rosNode_send(){
    QString send_msg = ui_->lineEdit_ros_input->text();
    emit signal_rosPub(send_msg);
    // 在发送页面展示
    QString str = addTimeStr("rosNode");
    str += send_msg;
